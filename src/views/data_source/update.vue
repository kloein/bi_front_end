...
<script>
import { update,test } from '@/api/data_source'
...
export default {
  ...
  methods: {
    onSubmit() {
      update(this.form.DataSourceName,this.form.URL,this.form.DataBase,this.form.UserName,this.form.Password,this.form.Comment,this.DataSourceID)
      .then(response =>{
